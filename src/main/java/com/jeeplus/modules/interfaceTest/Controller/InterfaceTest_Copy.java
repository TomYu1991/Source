...
@Controller
@RequestMapping(value = "${adminPath}/interface1")
public class InterfaceTest_Copy extends HttpServlet {
...
//    private static String url = "http://10.12.241.52:9080/dsdb/WebAccessManage";//;
        ...
        try {
            if (vehicleNo != null && !"".equals(vehicleNo)) {
                ...
                if (p.size() > 0) {
                    ...
                    jt.setData(ja);
                    System.out.println(JSONObject.fromObject(jt).toString());
                    String a = InterfaceTest_Copy.sendPost(url, JSONObject.fromObject(jt, jsonConfig));
                    System.out.println("a：" + a);
