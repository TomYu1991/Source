...
public class ScheduleJobController extends BaseController {
	...
	@ResponseBody
	public AjaxJson getjobstatus(ScheduleJob scheduleJob, RedirectAttributes redirectAttributes) {
		AjaxJson j = new AjaxJson();
		j.setSuccess(true);
		//j.setMsg("getjobstatus");

		String jobs = scheduleJobService.getjobstatus(scheduleJob);
