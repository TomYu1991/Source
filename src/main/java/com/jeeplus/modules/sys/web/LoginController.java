...
public class LoginController extends BaseController{
	 ...
	 */
	@ResponseBody
	@RequestMapping(value = "${adminPath}/checkAddr")
	public AjaxJson  checkAddr(HttpServletRequest request) {
		AjaxJson j = new AjaxJson();
		try {
			String a = request.getRemoteAddr();
			if("10.12.241.70".equals(a)){
				j.setSuccess(true);
				j.setObject("1");
				return j;
			}
			if("10.12.240.110".equals(a)||"10.12.240.120".equals(a)||"10.12.240.130".equals(a)){
				j.setSuccess(true);
				j.setObject("2");
				return j;
			}
			if("10.12.241.100".equals(a)){
				j.setSuccess(true);
				j.setObject("3");
				return j;
			}
			...
			if("10.12.241.106".equals(a)||"10.12.240.129".equals(a)){
				j.setSuccess(true);
				j.setObject("5");
				return j;
			}
			if("10.12.240.139".equals(a)){
				j.setSuccess(true);
				j.setObject("6");
				return j;
			}
			if("10.12.240.144".equals(a)){
				j.setSuccess(true);
				j.setObject("7");
				return j;
			}
			if("10.12.240.178".equals(a)){
				j.setSuccess(true);
				j.setObject("8");
				return j;
			}
			if("10.12.240.119".equals(a)){
				j.setSuccess(true);
				j.setObject("9");
				return j;
			}
			if("10.12.240.128".equals(a)){
				j.setSuccess(true);
				j.setObject("10");
				return j;
			}
