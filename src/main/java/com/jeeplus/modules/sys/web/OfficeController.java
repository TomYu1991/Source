...
public class OfficeController extends BaseController {
	...
	@ResponseBody
	@RequiresPermissions("user")
	@RequestMapping(value = "conditionData")
	public List<Map<String, Object>> conditionData(@RequestParam(required=false) String extId, @RequestParam(required=false) String type,
			@RequestParam(required=false) Long grade, @RequestParam(required=false) Boolean isAll, HttpServletResponse response, @RequestParam(required=false) String condition) {
		List<Map<String, Object>> mapList = Lists.newArrayList();
		List<Office> list = officeService.condition(type, condition);
		HashSet existIds = new HashSet();
		for(Office o : list){
			existIds.add(o.getId());
		}
