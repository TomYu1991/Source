...
public class UserUtils {
	...
	public static final String CACHE_SHIPSPACE = "shipspaceList";
	public static final String CACHE_LOAD_SHIPSPACE = "loadShipspaceList";
	public static final String CACHE_UNLOAD_SHIPSPACE = "UnLoadShipspaceList";
	public static final String CACHE_STATION = "stationList";
