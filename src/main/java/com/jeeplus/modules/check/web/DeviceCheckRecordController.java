 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/check/deviceCheckRecord")
public class DeviceCheckRecordController extends BaseController {
	...
	public String list(DeviceCheckRecord deviceCheckRecord, Model model) {
		...
		return "modules/check/deviceCheckRecordList";
	}
	...
	public Map<String, Object> data(DeviceCheckRecord deviceCheckRecord, HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        if(deviceCheckRecord.getSearchFlag()!=null&&"1".equals(deviceCheckRecord.getSearchFlag())){
            page = deviceCheckRecordService.findPage(new Page<DeviceCheckRecord>(request, response), deviceCheckRecord);
        }
	...
	public String form(DeviceCheckRecord deviceCheckRecord, Model model) {
		model.addAttribute("DeviceCheckRecord", deviceCheckRecord);
		return "modules/check/deviceCheckRecordForm";
	}
	...
	public String cancel(DeviceCheckRecord deviceCheckRecord, Model model) {
		model.addAttribute("DeviceCheckRecord", deviceCheckRecord);
		return "modules/check/deviceCheckRecordCancel";
	}
	...
	public String test(DeviceCheckRecord deviceCheckRecord, Model model) {
		model.addAttribute("DeviceCheckRecord", deviceCheckRecord);
		return "modules/check/deviceCheckRecordTest";
	}
...
//	 */
//	@ResponseBody
//	@RequiresPermissions(value={"userpasscord:DeviceCheckRecord:add","userpasscord:DeviceCheckRecord:edit"},logical=Logical.OR)
...
//		}
//		//新增或编辑表单保存
//		DeviceCheckRecordService.save(DeviceCheckRecord);//保存
//		j.setSuccess(true);
//		j.setMsg("保存员工通行记录成功");
//		return j;
//	}
...
//	 */
	...
	public AjaxJson updateCancel(DeviceCheckRecord deviceCheckRecord) {
		AjaxJson j = new AjaxJson();
		deviceCheckRecord.setIsFinished("1");
		Date date = new Date();
		deviceCheckRecord.setUpdateDate(date);
		deviceCheckRecord.setIsAborted("是");
		deviceCheckRecordService.updateCancel(deviceCheckRecord);
		j.setMsg("取消点检记录成功");
		return j;
	}
//
