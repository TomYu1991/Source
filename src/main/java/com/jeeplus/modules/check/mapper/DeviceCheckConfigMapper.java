 ...
 */
@MyBatisMapper
public interface DeviceCheckConfigMapper extends BaseMapper<DeviceCheckConfig> {

//    List<DeviceCheckRecord> findRecordById(DeviceCheckRecord deviceCheckRecord);

//    void saveUserPassInfo(UserPassRecord u);

//    void deleteUserPassInfo();

    DeviceCheckConfig findConfigById(String id);
