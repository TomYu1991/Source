...
public class SysDataSourceService extends CrudService<SysDataSourceMapper, SysDataSource> {
	...
	public List<SysDataSource> queryEnname(){
		return sysDataSourceMapper.queryEnname();
	}

	public void cancel(SysDataSource sysDataSource){
		sysDataSourceMapper.cancel(sysDataSource);
	}
