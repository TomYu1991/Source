...
<body class="">
	<nav class="navbar topnav-navbar navbar-fixed-top" role="navigation">
		<div class="navbar-header text-center">
			...
			<a class="navbar-brand J_menuItem"  href="${ctx}/home">宝&nbsp;钢&nbsp;德&nbsp;盛&nbsp;称&nbsp;重&nbsp;自&nbsp;动&nbsp;化及安环系统</a>
		</div>
...
<section id="body-container" class="animation">
		...
		<div class="main-container" id="main-container">
           ...
           <div class="footer">
                <div class="pull-left"><a href="http://www.matrixerp.com/">http://www.matrixerp.com/</a> &copy; 2015-2025</div>
            </div>
