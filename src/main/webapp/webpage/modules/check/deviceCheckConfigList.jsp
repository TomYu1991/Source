...
<head>
	...
	<%@include file="deviceCheckConfigList.js" %>
</head>
<body>
	<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">设备点检配置列表</h3>
	</div>
	...
	<div id="search-collapse" class="collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="deviceCheckConfig" class="form form-horizontal well clearfix">
...
<%--				</div>--%>
	...
	<!-- 工具栏 -->
	<div id="toolbar">
		<shiro:hasPermission name="check:deviceCheckConfig:add">
			<button id="add" class="btn btn-default" onclick="add()">
				<i class="fa fa-search-plus"></i> 新增配置
			</button>
		</shiro:hasPermission>
		...
		<shiro:hasPermission name="check:deviceCheckConfig:del">
	...
	<!-- 表格 -->
	<table id="deviceCheckConfigTable"   data-toolbar="#toolbar"></table>
