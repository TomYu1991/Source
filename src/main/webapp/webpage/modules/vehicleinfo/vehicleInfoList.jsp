...
<head>
	...
	<%@include file="vehicleInfoList.js" %>
...
<body>
	...
	<div id="search-collapse" class="collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="vehicleInfo" class="form form-horizontal well clearfix">
			 <div class="col-xs-12 col-sm-6 col-md-4">
				<label class="label-item single-overflow pull-left" title="类别代码：">车辆类别：</label>
				 <form:select id="typeCode" path="typeCode"  class="form-control m-b">
			 ...
			 <div class="col-xs-12 col-sm-6 col-md-4">
				...
				<div class="col-xs-12 col-sm-6 col-md-4">
					<label class="label-item single-overflow pull-left" title="组批代码：">组批代码：</label>
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			<%--<shiro:hasPermission name="vehicleinfo:vehicleInfo:add">
				<button id="add" class="btn btn-primary" onclick="add()">
					<i class="glyphicon glyphicon-plus"></i> 新建
				</button>
			</shiro:hasPermission>--%>
			<%--<shiro:hasPermission name="vehicleinfo:vehicleInfo:edit">
				<button id="edit" class="btn btn-success" disabled onclick="edit()">
					<i class="glyphicon glyphicon-edit"></i> 修改
				</button>
			</shiro:hasPermission>--%>
			<%--<shiro:hasPermission name="vehicleinfo:vehicleInfo:del">
				<button id="remove" class="btn btn-danger" disabled onclick="deleteAll()">
	            	<i class="glyphicon glyphicon-remove"></i> 删除
	        	</button>
			</shiro:hasPermission>--%>
			<%--<shiro:hasPermission name="vehicleinfo:vehicleInfo:import">
				<button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
			</shiro:hasPermission>--%>
			<shiro:hasPermission name="vehicleinfo:vehicleInfo:export">
	        		<button id="export" class="btn btn-warning">
					<i class="fa fa-file-excel-o"></i> 导出
				</button>
			 </shiro:hasPermission>
			<shiro:hasPermission name="vehicleinfo:vehicleInfo:edit">
				<button id="binding" class="btn btn-danger" disabled onclick="bindinga()">
					<i></i>绑定RFID卡1
				</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="vehicleinfo:vehicleInfo:edit">
				<button id="bindingRail" class="btn btn-warning" disabled onclick="bindingRail()">
					<i></i>绑定RFID卡2
				</button>
			</shiro:hasPermission>
			 <%--<shiro:hasPermission name="vehicleinfo:vehicleInfo:view">
	...
	<!-- 表格 -->
	<table id="vehicleInfoTable"   data-toolbar="#toolbar"></table>
