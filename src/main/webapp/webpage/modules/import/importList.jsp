...
<head>
	...
	<%@include file="importList.js" %>
</head>
<body>
<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h3 class="panel-title">导入管理页</h3>
		</div>
		<div class="panel-body">
			...
			<div id="toolbar">
				<%--<shiro:hasPermission name="synchroinfo:dataSynchroInfo:import">--%>
					<button id="wtdImport" class="btn btn-primary">
						<i class="fa fa-folder-open-o"></i>导入委托单
					</button>
					<button id="cmtImport" class="btn btn-success">
						<i class="fa fa-folder-open-o"></i>导入出门条
					</button>
					<button id="clxxImport" class="btn btn-danger">
						<i class="fa fa-folder-open-o"></i>导入车辆信息
				     </button>
				<%--</shiro:hasPermission>--%>
