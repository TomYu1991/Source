...
<%@ attribute name="info" type="java.lang.String" required="false" description="级联查询需要提示的信息"%>
<%@ attribute name="onchange" type="java.lang.String" required="false" description="自定义onchange方法"%>
    ...
    $(document).ready(function(){
        $("#${id}Button, #${id}Name").click(function(){
            ...
            top.layer.open({
                ...
                content: "${ctx}/tag/treeselect?url="+encodeURIComponent("${url}"+condition)+"&module=${module}&checked=${checked}&extId=${extId}&isAll=${isAll}&allowSearch=${allowSearch}" ,
                btn: ['确定', '关闭']
