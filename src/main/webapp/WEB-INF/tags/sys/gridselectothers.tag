...
$(document).ready(function(){
	$("#${id}Button, #${id}Name").click(function(){
		...
		if ($("#common").val()!=undefined&&$("#common").val()!=null&&$("#common").val()!="") {
			if ($("#common").val()=="stockaddassay") {
				if ($("#varietyId").val()!=undefined) {
					var varid=$("#varietyId").val();
					var url="${ctx}/qualityassaydict/qualityAssaydict/data?varid="+varid;
					top.layer.open({
					    type: 2,  
					    area: ['800px', '500px'],
					    title:"${title}",
