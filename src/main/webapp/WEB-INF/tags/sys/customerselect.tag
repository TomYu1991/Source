...
<%@ attribute name="ctype" type="java.lang.String" required="false" description="客户分类"%>
...
<script type="text/javascript">
	$("#${id}Button, #${id}Name").click(function(){
		...
		// 正常打开	
      jp.openCustomerSelectDialog(${isMultiSelected? true:false},${ctype},function(ids, names){
        $("#${id}Id").val(ids);
        $("#${id}Name").val(names);
        $("#${id}Name").focus();
      })
